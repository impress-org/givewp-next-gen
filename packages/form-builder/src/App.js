...
function App() {
    const {state: showSecondarySidebar, toggle: toggleSecondarySidebar} = useToggleState(false);
    ...
    const saveCallback = () => {
        return Storage.save({blocks, formSettings}).catch((error) => alert(error.message));
    };
